-- ============================================================
-- Migration: good_company becomes ten followers.
...
-- rung it sits on.
--
-- Five was tried first and was still too generous, landing on 35 of 48: signup
-- wires up followers liberally, 500 follow rows across 48 accounts. Measured
-- across candidates -- 5:35, 8:24, 10:22, 12:20, 15:14 -- ten is where the
-- curve flattens, and the last round number before this starts excluding
-- people who genuinely have an audience.
--
