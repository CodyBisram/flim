...
/// Pins `ActivationEvent`'s raw values to exactly the eight strings the server's
...
struct ActivationEventTests {
    ...
    @Test("the enum has exactly the eight allowed events, no more, no fewer")
    func exactlyEightEvents() {
